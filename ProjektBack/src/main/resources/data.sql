...
VALUES ('1a-b1/1+1', default,  '30-09-1999'::date, 'Peeter', 'Tarvas', 'Afganistaan', 'peetertarvas@gmail.com', 'EST', 1);

INSERT INTO isik(isikukood,reg_aeg,  synni_kp, eesnimi, perenimi, elukoht, e_meil, riik_kood, isiku_seisundi_liik_kood)
VALUES ('11111112', default, '29-09-1999'::date, 'Rahul', 'Kersna', 'Kehra', 'veetertarvas@gmail.com', 'SWE', 0);

INSERT INTO isik(isikukood,reg_aeg, synni_kp, eesnimi, perenimi, elukoht, e_meil, riik_kood, isiku_seisundi_liik_kood)
VALUES ('11111113', '29-09-2020'::date, '29-09-1999'::date, 'Eeter', 'Tamm', 'Kehra', 'eetertarvas@gmail.com', 'FIN', 0);
...
INSERT INTO laadimispunkt(laadimispunkti_kood, laiuskraad, laadimispunkti_nimetus, pikkuskraad, reg_aeg, registreerija_id, laadimispunkti_seisundi_liik_kood, laadimispunkti_tyyp_kood)
VALUES (4, 12.2, 'Neljas', 15.1, '29-09-2012'::date, 2, 3, 0);
